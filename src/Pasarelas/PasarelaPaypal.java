...
public class PasarelaPaypal implements PasarelaDePago {
	@Override
    ...
    public static void generarRegistro(String line) {
        try {
            FileWriter writer = new FileWriter("./data/paypal.txt", true);  // true indica que se agregará al final del archivo
